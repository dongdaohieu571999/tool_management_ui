...
for(let relate of this.relatedPerson){
  ...
  next(){
    ...
    this.relateSer.addRelatedPerson({full_name:relatePer.full_name,
    ...
    id_illustration:this.id_ill}).subscribe((data => {
  ...
  save(){
    ...
    this.relateSer.addRelatedPerson({full_name:this.illustrationMainInterest.full_name_insured_person,
