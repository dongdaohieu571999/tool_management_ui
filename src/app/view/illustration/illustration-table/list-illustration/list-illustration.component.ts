...
export class ListIllustrationComponent implements OnInit {
  ...
  constructor(private spinner: NgxSpinnerService,private router:Router,private illustrationService : IllustrationService,private activateRoute:ActivatedRoute) { }
  page=1;
  totalRecords:number;
